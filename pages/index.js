  ...
  return (
    <div className={styles.container}>
      ...
      <Row>
        ...
        <Col span={18} style={{marginRight:'21px'}} >
          <Carousel autoplay>
            {
              props.media.map((p, i) => (
                <div key={i} style={{textAlign:'center'}} >
                    <IMG 
                      src={p.media_details.sizes.medium_large.source_url} 
                      alt={p.slug} height={400} width={900} />
          ...
          <Carousel autoplay>
            {
              props.posts.map((post, i) => (
                <div key={i}>
                  <h5 style={contentStyle} > { post.title.rendered } </h5>
